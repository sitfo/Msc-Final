...
\begin{table}
    ...
    3               & \ding{55}     & \ding{55}         & \ding{55}    \\ \midrule
    4               & \ding{52}     & \ding{52}         & \ding{55}    \\ \midrule
    5               & \ding{55}     & \ding{55}         & \ding{52}    \\ \midrule
    ...
    10              & \ding{55}     & \ding{55}         & \ding{52}    \\ \midrule
    ...
    38              & \ding{52}       & \ding{55}               & \ding{55}          \\ \midrule
    39              & \ding{52}       & \ding{52}               & \ding{55}          \\ \midrule
    40              & \ding{55}       & \ding{55}               & \ding{52}          \\ \bottomrule
    \end{tabular}%
    }
\end{table}
\begin{table}[]
