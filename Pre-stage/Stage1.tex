...
Collectively, these studies shed light on the challenges LLMs face when it comes to Spatial Reasoning, including inconsistencies in responses, struggles with direct spatial question answering, and difficulties in solving specific spatial tasks like path finding. But there are a few research on the Spatial Reasoning abilities of Visual Language Models (VLMs), which are a subset of LLMs that incorporate visual information into their training process. 
