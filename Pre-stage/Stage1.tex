...
Spatial Reasoning is one of core part of commonsense reasoning since 
...
\begin{figure*}[!htbp]
  ...
  \caption{Examples of spatial reasoning benchmarks. (a)Example in benchmark proposed by Cohn et al. (2023) \cite{cohn2023dialectical}. (b)Example of GQA \cite{hudson2019gqa}. (c)Example of AGQA \cite{grunde2021agqa}. (d)Example in benchmark proposed by Liu et al. (2021) \cite{liu2022things}.}
