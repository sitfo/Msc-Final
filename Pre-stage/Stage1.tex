...
For the experiment stage, the work flow can be shown as Figure \ref{fig:workflow}. The experiment will be divided into two parts: (i) dataset preparation and (ii) experiment conduction. The dataset preparation part will be divided into three parts: (i) visual stimuli preparation, (ii) question preparation, and (iii) dataset construction. The experiment conduction part will be divided into two parts: (i) model preparation and (ii) experiment conduction. The model preparation part will be divided into two parts: (i) model selection and (ii) model modification. The experiment conduction part will be divided into two parts: (i) experiment conduction and (ii) result analysis.
